...
filepath = './low_res/100/classification/huff_train_processed_filtered_generated.source'
tokenizer = AutoTokenizer.from_pretrained('./amr-data-augmentation/checkpoint-7480')
model_pipeline = pipeline("text2text-generation", model='./amr-data-augmentation/checkpoint-7480', tokenizer=tokenizer, device=0)
...
train_og = pd.read_csv('./low_res/100/classification/huff_train.tsv', delimiter='\t')
